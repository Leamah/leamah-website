...
export const metadata: Metadata = {
  title: 'Kuco | Retail and Inventory Management Software',
  description:
    'Kuco helps South African retailers manage multi-store stock, automate purchase orders, track staff and prevent losses. Real-time visibility for growing retail businesses.',
};
...
const FEATURES = [
  ...
  },
  {
    ...
    desc: 'Set reorder points and let Kuco generate purchase orders automatically when stock drops below threshold.',
  },
  {
...
export default function KucoPage() {
  return (
    <>
      <ProductHero
        badge="Retail and Inventory"
        headline="Run your retail business without the guesswork"
        intro="Kuco gives growing South African retailers the tools to manage stock, staff and suppliers from a single platform. No spreadsheets. No blind spots."
        features={FEATURES.map((f) => f.title)}
        variant="kuco"
        ctaText="Book a Kuco Demo"
        accentColor="#4ade80"
      />
        ...
        <div className="max-w-6xl mx-auto">
          <ScrollReveal className="text-center mb-14">
            ...
            <p className="text-gray-500 max-w-xl mx-auto">
              Kuco is built around the realities of South African retail, including multi-location complexity and tight margins.
            </p>
          </ScrollReveal>
        ...
        <div className="max-w-3xl mx-auto text-center">
          <ScrollReveal>
            ...
            <p className="text-white/70 text-lg leading-relaxed mb-4">
              Kuco is not an imported solution adapted for local conditions. It was built here, for the challenges you face every day: variable supplier reliability and customers who expect more than ever.
            </p>
            <p className="text-white/70 text-lg leading-relaxed mb-8">
              Whether you run a single shop or a chain across multiple provinces, Kuco scales with you and keeps you in control.
            </p>
            <Link
